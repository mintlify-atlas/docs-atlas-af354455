...
<Card title="Check out the .md file for this page" href="https://gitbook.com/docs/publishing-documentation/llm-ready-docs.md" />
...
<Card title="Check out the /llms.txt for the GitBook docs" href="https://gitbook.com/docs/llms.txt" />
...
<Card title="Check out the /llms-full.txt file for the GitBook docs" href="https://gitbook.com/docs/llms-full.txt" />
...
Learn more by reading [MCP servers for published docs](/publishing/mcp-servers).
