...
By combining filters and groups, you can drill down into precise analytics data to track the events that are important to you.
...
Pages & feedback allow you to see a high-level representation of how your users rate your content. You'll see an overview of all of your site's sections and variants, and after enabling page rating in the settings, you can see each page's average feedback rating.
...
GitBook tracks links to help you understand how users interact with external resources in your documentation. This feature provides insights into external links, their domains, and their placement within your docs, such as in the header, footer, or sidebar.

Analyzing link usage can help you optimize navigation, improve content accessibility, and refine your documentation strategy based on user engagement.
