...
Read our [CI/CD integration guide](/api-reference/guides/ci-cd-integration) to learn how to automate the update of your specification with GitHub Actions or other CI/CD tools.