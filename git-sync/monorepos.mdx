---
title: Monorepos
description: Configure Git Sync to work with monorepo repository structures
---
...
Here's an example of a monorepo structure that can be synced with GitBook:
...
<Warning>
Always backup your repository before making significant changes to the Project directory configuration.
</Warning>