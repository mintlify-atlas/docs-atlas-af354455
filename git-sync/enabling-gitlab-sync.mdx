...
This guide walks you through setting up GitLab Sync to connect your GitBook space with a GitLab repository.
...
<Steps>
  ...
  <Step title="Generate and enter your API access token">
