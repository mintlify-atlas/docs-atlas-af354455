...
description: Common issues and solutions for Git Sync
---

This guide covers common issues you might encounter when using Git Sync and how to resolve them.
...
By default, GitBook uses the root of the repository as a starting point. A specific directory can be specified to scope the markdown files. Take a look at the [content configuration](/git-sync/content-configuration) documentation for more details.
...
Make sure that you have installed the GitBook GitHub app to the correct locations (when installing the app, you can choose to install it to your personal GitHub, or to any organization you have permissions for) and that you've given the app the correct repository permissions.
...
<Steps>
  <Step title="Uninstall the GitSync integration">
    Uninstall the GitSync integration from your organization.
  </Step>

  <Step title="Reinstall with updated permissions">
    Reinstall the new version with the updated permissions.
  </Step>
</Steps>
...
<Steps>
  <Step title="Log out from GitBook">
    Log out from your current GitBook user session (i.e. `name@email.com`).
  </Step>

  <Step title="Log out from GitHub">
    Log out from any GitHub user sessions.
  </Step>

  <Step title="Sign in with GitHub">
    Go to the Log in page and select the "Sign in with GitHub" option. Enter your GitHub credentials.
  </Step>

  <Step title="Unlink or delete account">
  ...
  <Step title="Log back in and retry">
    Log out from the session, then log back in using your `name@email.com` GitBook account. Try to set up Git Sync again.
  </Step>
</Steps>