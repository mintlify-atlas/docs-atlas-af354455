...
<Steps>
  ...
  <Step title="Navigate to merge rules">
    In the Settings screen, select **Merge rules** under the Organization section
  </Step>
  
  <Step title="Configure rules">
    Choose between unrestricted merging or select from the list of presets to apply across your entire organization
  </Step>
</Steps>
...
To configure merge rules for a space, open the **Actions menu** in the top left of the editor, and then select **Merge rules**. Here you can specify whether to inherit the merge rules from your organization or configure new ones specific to that space.
